...
function embedBlocChatBot() {
  ...
  document.body.appendChild(iframe);
    ...
    function getBlocIcon() {
        ...
        const imageEle = `<img src="${CHAT_BUTTON_ICON}" width="100%" height="100%" />`
    
        return imageEle; // return USER_ADDED_CHAT_ICON
      }
    ...
      `;
        ...
        const imageEle = `<img src="${CHAT_BUTTON_CLOSE}" width="100%" height="100%" />`
        return imageEle;
      }
